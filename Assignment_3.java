/*
 * Create a library Management System in JAVA using classes and objects invloves designing several classes
 * to represent different entities in the library, such as books, library members and the library itself.
 * Here's a basic but distinct implementation of a Library Management System: 
 * Classes to be Implemented: 
 * 1. Book: Represents a Book with attributrs like title , author, ISBN, and availability status.
 * 2. Member: Represents a library member with attributes like name, Member Id, and a list of borrowed books.
 * 3. Library: Manages the collection of books and members, and handles the borrowing and returned of books.
*/
import java.util.*;
class Book
{
